...
function startJourney() {
    ...
    const fileSystemCrawler = new file_system_crawler_1.FileSystemCrawler(crawlingPath, new type_script_file_crawler_factory_1.TypeScriptFileCrawlerFactory(table, tableFormatter), fileExtensionValidator, new file_determiner_1.FileDeterminer(), new directory_crawler_1.DirectoryCrawler());
